module.exports = {
  ...
  installInto(expect) {
      ...
      (expect, subject, value) => {
        ...
        return expect.promise((resolve, reject) => {
          ...
          if (!subjectType.is('Stream')) {
            ...
            try {
              (Array.isArray(subject) ? subject : [subject]).forEach(chunk => {
    ...
    expect.addAssertion('<Stream> to error', (expect, subject) => getChunkPromise(subject).then(
      () => {
        expect.fail(
