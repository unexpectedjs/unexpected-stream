...
describe('unexpected-stream', function() {
  ...
  var fooTxtPath = pathModule.resolve(__dirname, '..', 'testdata', 'foo.txt');
  ...
  it('should identify a stream-like object with a readable property of true', function() {
    expect(
      expect.getType('Stream').identify({ on: function() {}, readable: true }),
      'to be true'
    );
  });
  ...
  it('should identify a stream-like object with a writable property of true', function() {
    expect(
      expect.getType('Stream').identify({ on: function() {}, writable: true }),
      'to be true'
    );
  });
